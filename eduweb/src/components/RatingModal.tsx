 ...
 *
 * Interactive modal for submitting course ratings on the learning page.
 * Allows users to rate courses they are enrolled in with a 1-5 star system.
 */
...
export const RatingModal = ({
  ...
  // Hooks for rating functionality
  ...
  }, [selectedRating, course.id, submitRating, refetchUserRating, onRatingSubmitted, onClose]);
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-lg">
          ...
          {!canRate ? (
            <Alert>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{cantRateReason}</p>
              </div>
            </Alert>
          ) : (
            <div className="space-y-4">
              ...
              {hasCurrentRating && (
                <div className="p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                  <p className="text-sm font-medium text-blue-900 dark:text-blue-100">
                    Your current rating: {formatRatingDisplay(currentUserRating)}
                  </p>
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">
                  {hasCurrentRating ? 'Update your rating:' : 'Rate this course:'}
                </label>
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          {/* Delete Button (if user has existing rating) */}
